...
public class UserSpringSecurity implements UserDetails {
    ...
    //setamos true porque não iremos implementar nada de contas expiradas
    @Override
    public boolean isAccountNonExpired() {
        return true;
    }
    //setamos true porque não iremos implementar nada de contas bloqueadas
    @Override
    public boolean isAccountNonLocked() {
        return true;
    }
    //setamos true porque não iremos implementar nada de credenciais expiradas
    @Override
