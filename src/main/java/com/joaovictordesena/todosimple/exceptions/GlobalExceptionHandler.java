...
public class GlobalExceptionHandler extends ResponseEntityExceptionHandler implements AuthenticationFailureHandler {
    ...
    //captura qualquer tipo de exceção no nosso sistema, que for um argumento invalido
    ...
    //retorna uma mensagem de erro padrão para os erros que ainda não foram tratados
    ...
    //esse metodo não passa uma mensagem, a mensagem vai ser gerada automaticamente pela exceção
